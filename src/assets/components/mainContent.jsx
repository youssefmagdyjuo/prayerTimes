...
export default  function MainContent() {
    ...
    <div>
        ...
        <Stack  alignItems='center' style={{margin:'4rem auto'}}>
            <FormControl className='select'>
                ...
                onChange={handelcoutry}>
                {
                    ...
                    allthing.map((c,index)=>{
                        return (
                            <MenuItem key={index} value={c.countryEn}>{c.countryAr}</MenuItem>
                        )
                    })
                }
                </Select>
            ...
            <FormControl className='select'>
                ...
                onChange={handlCity}>
                {
                    ...
                    avaliblcities.map((city,index)=>{
                        return (
                            <MenuItem key={index} value={city.nameEn}>{city.nameAr}</MenuItem>
                        )
                    })
                }
                </Select>
